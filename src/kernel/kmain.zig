...
const mem = if (builtin.is_test) @import("../../test/mock/kernel/mem_mock.zig") else @import("mem.zig");
...
const panic_root = if (builtin.is_test) @import("../../test/mock/kernel/panic_mock.zig") else @import("panic.zig");
